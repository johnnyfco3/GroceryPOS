...
<head>
  ...
  <title>Categories | MarketPOS</title>
 ...
 <!--END nav sidebar-->
  ...
  <div id="content">
    ...
    <nav class="navbar navbar-light" id="salespanel">
      <form class="form-inline" method="post" action="categoryview.php">
            ...
            if (isset($_POST['submit-search'])) {
              ...
              if ($queryResults > 0) {
                ...
                while ($row = mysqli_fetch_assoc($result)) {
                    ...
                    . $row['productType'] . "</td><td>" . $row['productName'] . "</td><td>"
                    . $row['description'] . "</td><td>". $row['vendor_id'] . "</td><td>";
                }
              } else {
