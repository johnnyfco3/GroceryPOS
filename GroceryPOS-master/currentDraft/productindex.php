...
<head>
  <title>Add Product | MarketPOS</title>
      ...
      <div class="container-fluid">
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
          <ul class="nav navbar-nav mr-auto">
            <a class="navbar-brand" href="inventorycontrol.php"><svg width=".8em" height=".8em" viewBox="0 0 16 16" class="bi bi-person-bounding-box" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
      ...
      <div class="card card-body bg-light" style="width: 35rem;" id="formscreen">
        ...
        <div class="card-body">
          ...
          <div class = "form-group row">
            ...
            <div class = "form-group row">
            <label class = "col-4" for = "Product Type">Product Type </label>
            <input class ="col-6" type = "text" placeholder="Product Type " name="ptype"/>
            </div>
              <div class = "form-group row">
            <label class = "col-4" for = "Product SubType">Product SubType </label>
            <input class ="col-6" type = "text" placeholder="Product SubType " name="psub"/>
            </div>
            <div class = "form-group row">
            <label class = "col-4" for = "Unit Price">Unit Price </label>
