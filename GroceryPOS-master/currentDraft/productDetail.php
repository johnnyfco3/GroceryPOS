...
if (isset($_GET['Detail'])) {
    $findID = $_GET['Detail'];
    $query = "SELECT * FROM product_inventory WHERE product_id LIKE '%$findID%'";
        ...
        <div class="card mt-5 bg-light">
          <table class="table table-bordered" style="font-size:80%;">
            <thead>
              <tr>
                <th class="col"> ID </th>
                <th class="col"> Prodcuct Name </th>
                <th class="col"> Product Type </th>
                <th class="col"> Product SubType </th>
                <th class="col"> Unit Price </th>
                <th class="col"> Cost </th>
                <th class="col"> In Stock </th>
                <th class="col"> Vendor Info </th>
                <th class="col"> Order Info </th>
              </tr>
            </thead>
            <tbody>
              <?php
                ...
                while ($row = mysqli_fetch_assoc($result)) {
                  echo "<tr><td>" . $row['product_id'] . "</td><td>"
                    ...
                    . $row['unit_price'] . "</td><td>" . $row['cost'] . "</td><td>" . $row['in_stock'] . "</td><td>
                    <a class='btn btn-dark' role='button' href='vendorDetail.php?Detail=". $row['vendor_id'] . "'>View</a></td><td>
                    <a class='btn btn-dark' role='button' href='orderDetail.php?Detail=". $row['OID'] . "'>View</a>";
                }
            }
