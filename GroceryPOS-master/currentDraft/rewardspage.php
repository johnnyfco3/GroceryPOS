...
<head>
  <title>Customers with Rewards | MarketPOS</title>
...
<!--END nav sidebar-->
  ...
  <div id="content">
          ...
          <ul class="nav navbar-nav mr-auto">
            <div class="navbar-brand">
              <a href="customercontrol.php"><svg width=".8em" height=".8em" viewBox="0 0 16 16" class="bi bi-people-fill" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
                  <path fill-rule="evenodd" d="M7 14s-1 0-1-1 1-4 5-4 5 3 5 4-1 1-1 1H7zm4-6a3 3 0 1 0 0-6 3 3 0 0 0 0 6zm-5.784 6A2.238 2.238 0 0 1 5 13c0-1.355.68-2.75 1.936-3.72A6.325 6.325 0 0 0 5 9c-4 0-5 3-5 4s1 1 1 1h4.216zM4.5 8a2.5 2.5 0 1 0 0-5 2.5 2.5 0 0 0 0 5z" />
                </svg> Customers</a><span class="px-2"> > </span><a href="rewardspage.php"><span>Rewards</span></a>
            </div>
    ...
    <nav class="navbar navbar-light" id="salespanel">
      <form class="form-inline" method="post" action="rewardspage.php">
        ...
        <table class="table table-bordered table-hover" style="font-size:90%;">
          ...
          <tbody class="bg-white">
            ...
            if (isset($_POST['submit-search'])) {
              ...
              $query = "SELECT * FROM customer_info WHERE first_name LIKE '%$search%' OR last_name LIKE '%$search%' AND rewards >= 0";
              ...
              $query = "SELECT * FROM customer_info WHERE rewards >= 0 ";
              $result = mysqli_query($conn, $query);
            }

            while ($row = mysqli_fetch_assoc($result)) {
              $customerID = $row['customer_id'];
              $tquery = "SELECT * FROM ticket_system WHERE customer_id LIKE '%$customerID%'";
